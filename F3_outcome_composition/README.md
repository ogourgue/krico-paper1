...
- Layers, bottom to top (with manuscript labels and internal flag names):
  ...
  - Calyptopis starvation (M4) — `killed_M4` — during calyptopis window (starvation under sea ice)
